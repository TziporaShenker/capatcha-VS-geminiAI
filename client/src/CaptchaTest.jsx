...
const CaptchaTest = () => {
  ...
  //       sx={{
  //         display: "flex",
  //         justifyContent: "space-between", // קפצ'ה בצד ימין, כפתורים במרכז
  ...
  //         sx={{
  //           display: "flex",
  //           flexDirection: "column", // מסדר את הכפתורים אחד מתחת לשני
  ...
  //       {/* הקפצ'ה בצד ימין */}
  //       <Box sx={{ flex: 1, display: "flex", justifyContent: "flex-end",marginTop: "150px" }}>
